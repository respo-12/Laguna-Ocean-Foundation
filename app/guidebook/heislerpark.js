...
import HeislerPic from '../../assets/heisler.jpg'
...
export default function Crescent() {
    const initial = { lat: 33.542717357425645, lng: -117.78775366836816 };
        ...
        <View style={{ flexDirection: 'column', height: '100vh', width: '100vw' }}>
            ...
            <View style={styles.outside}>
                <View style={styles.container}>
                    ...
                    <Image style={styles.image} source={HeislerPic} />
                    ...
                    <Text>Located along Cliff Drive, Heisler Park is an oceanfront park that is home to a plethora of attractions, such as walking trails, gardens, and tide pools. </Text>
                    ...
                    <View style={styles.textSection}>
                        ...
                        <View style={{ flexDirection: 'row', columnGap: 30 }}>
                            <Text></Text>
                            <Image style={styles.imageSmall} source={HeislerPic} />
                        </View>
                    </View>
                    <View>
                        <Text style={styles.subheading}>How To Get There</Text>
                        <Text style={{ marginVertical: 10 }}>Access Points to get to Heisler:</Text>
                        <ul  >
                            <li >La Brisas stairs</li>
                            <li>Main Beach</li>
                        </ul>
