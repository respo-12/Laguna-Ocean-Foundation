...
import GoffPic from '../../assets/Goff.jpg'
        ...
        <View style={{ flexDirection: 'column', height: '100vh', width: '100vw' }}>
            ...
            <View style={styles.outside}>
                <View style={styles.container}>
                    ...
                    <Image style={styles.image} source={GoffPic} />
                    ...
                    <Text>This pristine beach is sheltered by Goff Island, providing calm waters for swimming and exploring tide pools. The natural landmarks provide safety for young adventurers.</Text>
                    ...
                    <View style={styles.textSection}>
                        ...
                        <View style={{ flexDirection: 'row', columnGap: 30 }}>
                            ...
                            <Image style={styles.imageSmall} source={GoffPic} />
                        </View>
                    </View>
                    <View>
                    ...
                    <View style={{ width: '70vw' }}>
                        ...
                        <View style={{ flexDirection: 'row', width: '80vw', justifyContent: 'center' }}>
                            ...
                            <View style={[styles.grid2, { borderBottomWidth: 2 }]}>
                                <Text style={{ width: '30vw', fontSize: '1rem', textAlign: 'center' }}>Metered Parking</Text>
                            </View>
                        </View>
                        <View style={{ flexDirection: 'row', width: '80vw', justifyContent: 'center' }}>
                            <View style={[styles.grid1, { borderBottomWidth: 2}]}>
